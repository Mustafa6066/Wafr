...
export const CATEGORIES = [
  ...
  { id: "telecom", icon: "📱", name: "Telecom & Internet", nameAr: "اتصالات وإنترنت", color: "#7B68EE" },
  { id: "fuel", icon: "⛽", name: "Fuel & Gas", nameAr: "وقود وبنزين", color: "#E67E22" },
  { id: "subscriptions", icon: "🔄", name: "Subscriptions", nameAr: "اشتراكات", color: "#9B59B6" },
  { id: "charity", icon: "🤲", name: "Charity & Zakat", nameAr: "صدقة وزكاة", color: "#1ABC9C" },
  { id: "personal", icon: "💅", name: "Personal Care", nameAr: "عناية شخصية", color: "#FF69B4" },
  { id: "travel", icon: "✈️", name: "Travel", nameAr: "سفر", color: "#3498DB" },
  { id: "insurance", icon: "🛡️", name: "Insurance", nameAr: "تأمين", color: "#2C3E50" },
  { id: "investments", icon: "📈", name: "Investments", nameAr: "استثمارات", color: "#27AE60" },
  { id: "gifts", icon: "🎁", name: "Gifts", nameAr: "هدايا", color: "#E74C3C" },
